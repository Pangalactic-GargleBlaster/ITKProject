...
def onlyLungs(image: sitk.Image):
    ...
    return mask_filter.Execute(image, binary_image)
...
reference_dicom_directory = "C:/Users/paolo/Desktop/821/CovidScans/manifest-1608266677008/MIDRC-RICORD-1A/MIDRC-RICORD-1A-419639-000082/08-02-2002-NA-CT CHEST WITHOUT CONTRAST-04614/3.000000-0.625mm bone alg-26970/"
...
reference_lungs = onlyLungs(reference_image)
print("reference lung field ready")
image_viewer.Execute(reference_image)

metadata_path = "C:/Users/paolo/Desktop/821/CovidScans/manifest-1608266677008/metadata.csv"
...
with open(metadata_path, "r") as metadata_file:
	...
	for line in lines:
		if line.split(",")[8] == "0.625mm bone alg":
			...
			dicom_directory = "C:/Users/paolo/Desktop/821/CovidScans/manifest-1608266677008/"+local_path[1:]
			...
			lungs_only_image = onlyLungs(image)
